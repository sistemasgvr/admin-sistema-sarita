...
import { createBalonesRutasPueblosTutorial } from '@/modules/soporte/tutorials/balones-rutas-pueblos.tutorial'
...
useTutorialAutoStart('balones-rutas-pueblos', createBalonesRutasPueblosTutorial)
