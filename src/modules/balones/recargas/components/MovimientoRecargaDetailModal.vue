...
const sections = computed<DetailSection[]>(() => {
  ...
  return [
    ...
    { title: 'Factura y retorno', icon: ICONS.creditCard, items: [
        ...
        { label: 'ID comprobante venta', value: data.id_comprobante?.toString() },
        { label: 'ID comprobante compra', value: data.id_comprobante_compra?.toString() },
        { label: 'Balón origen', value: data.codigo_balon_origen || data.id_balon_origen?.toString() },
