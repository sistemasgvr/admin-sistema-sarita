...
export function useDashboardRentabilidadQuery(
  ...
  return useQuery({
    queryKey: computed(() => dashboardQueryKeys.rentabilidad(resolvedParams.value)),
    queryFn: () => dashboardService.rentabilidad(resolvedParams.value),
    enabled: computed(
      () =>
