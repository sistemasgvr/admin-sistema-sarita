    ...
    >
      ...
      >
        ...
        <ul v-else class="space-y-3.5">
          <li v-for="producto in demandaGasesDetalle" :key="producto.idProducto">
            <div class="mb-1 flex items-center justify-between gap-2 text-theme-sm">
              <span class="truncate text-gray-600 dark:text-gray-300">{{ producto.producto }}</span>
            ...
            <div class="h-1.5 w-full overflow-hidden rounded-full bg-gray-100 dark:bg-white/10">
              <div
                class="h-full rounded-full bg-teal-500 dark:bg-teal-400"
