...
export const configuracionHubItems: ConfiguracionHubItem[] = [
  ...
  },
  {
    key: 'choferes',
    title: 'Choferes',
    description: 'Choferes / repartidores de la flota propia (no de clientes).',
  ...
  },
  {
    key: 'vehiculos',
    title: 'Vehículos',
    description: 'Unidades de la flota propia de la empresa.',
  ...
  },
  {
    ...
    description: 'Cuentas de la empresa para cobros, pagos y depósitos.',
