    ...
    sheets: [
      {
        ...
        rows: clienteRows,
        title: `Clientes — Total: ${clienteRows.length} registros`,
      },
      {
        name: 'Direcciones',
        columns: direccionColumns,
        rows: direccionRows,
        title: `Direcciones — Total: ${direccionRows.length} registros`,
      ...
      },
      {
        ...
        rows: vehiculoRows,
        title: `Vehículos — Total: ${vehiculoRows.length} registros`,
      ...
      },
      {
        ...
        rows: choferRows,
        title: `Choferes — Total: ${choferRows.length} registros`,
      ...
      },
      {
        ...
        rows: cuentaRows,
        title: `Cuentas bancarias — Total: ${cuentaRows.length} registros`,
