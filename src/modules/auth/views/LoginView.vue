  ...
  <FullScreenLayout>
    <div class="relative p-6 bg-white z-1 sm:p-0">
      <div class="relative flex flex-col justify-center w-full h-screen lg:flex-row">
        ...
        <div class="relative items-center hidden w-full h-full overflow-hidden lg:w-1/2 brand-panel-gradient lg:grid">
          <div class="absolute inset-0 opacity-30">
            <CommonGridShape />
          </div>
          <div class="relative flex items-center justify-center z-1">
            <div class="flex flex-col items-center max-w-sm px-8">
              <div class="mb-8 rounded-2xl bg-white/10 p-6 backdrop-blur-sm ring-1 ring-white/20">
                <img
                  width="300"
                  height="130"
              ...
              <p class="text-center text-base font-medium text-white/90">
                Panel de administración
              </p>
              <p class="mt-1 text-center text-sm text-white/60">Sistema Sarita</p>
            </div>
          </div>
        </div>
      </div>
